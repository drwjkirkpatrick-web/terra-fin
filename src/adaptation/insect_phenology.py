...
class InsectPhenology(AdaptationModule):
    ...
    # ------------------------------------------------------------------ #
    @staticmethod
    def _stage_for_total(total: float) -> str:
    ...
    @staticmethod
    def _risk_for_stage(stage: str) -> str:
    ...
    @staticmethod
    def _advisory_for_stage(stage: str) -> tuple[str, float, str]:
